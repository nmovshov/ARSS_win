...
*/
//////////////////////////////////////////////////////////////////////////
class VisualDebugger : public PxVisualDebugger, public Ps::UserAllocated, public physx::debugger::comm::PvdConnectionHandler, public Pvd::BufferRegistrar, public GuMeshFactoryListener
{
public:
	VisualDebugger ();

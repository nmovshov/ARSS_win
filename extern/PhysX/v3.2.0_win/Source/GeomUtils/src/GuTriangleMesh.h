...
//~PxTriangleMesh
	...
	PX_FORCE_INLINE	void						computeWorldTriangle(PxTriangle& worldTri, PxTriangleID triangleIndex, const Cm::Matrix34& worldMatrix, PxU32* PX_RESTRICT vertexIndices=NULL) const;
	...
	PX_FORCE_INLINE	const Ice::HybridModel&		getOpcodeModel()					const	{ return mMesh.getOpcodeModel();				}
...
PX_FORCE_INLINE void Gu::TriangleMesh::computeWorldTriangle(PxTriangle& worldTri, PxTriangleID triangleIndex, const Cm::Matrix34& worldMatrix, PxU32* PX_RESTRICT vertexIndices) const
{

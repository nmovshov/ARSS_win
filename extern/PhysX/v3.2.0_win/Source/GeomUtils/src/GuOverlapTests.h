...
//	PX_PHYSX_COMMON_API bool intersectSphereConvex	(const PxSphereGeometry& sphereGeom, const PxTransform& sphereGlobalPose, const Gu::ConvexMesh& mesh, const PxMeshScale& meshScale, const PxTransform& convexGlobalPose, PxVec3* cachedSepAxis);
	...
	PX_PHYSX_COMMON_API bool intersectSphereMeshAny	(const Gu::Sphere& worldSphere,		const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);
	PX_PHYSX_COMMON_API bool intersectCapsuleMeshAny(const Gu::Capsule& worldCapsule,	const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);
	PX_PHYSX_COMMON_API bool intersectBoxMeshAny	(const Gu::Box& worldOBB,			const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling);

	PX_PHYSX_COMMON_API PxU32 findOverlapSphereMesh	(const Gu::Sphere& worldSphere,		const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling, PxU32* PX_RESTRICT results, PxU32 maxResults, PxU32 startIndex, bool& overflow);
	PX_PHYSX_COMMON_API PxU32 findOverlapCapsuleMesh(const Gu::Capsule& worldCapsule,	const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling, PxU32* PX_RESTRICT results, PxU32 maxResults, PxU32 startIndex, bool& overflow);
	PX_PHYSX_COMMON_API PxU32 findOverlapOBBMesh	(const Gu::Box& worldOBB,			const Ice::HybridModel& meshModel, const PxTransform& meshTransform, const PxMeshScale& scaling, PxU32* PX_RESTRICT results, PxU32 maxResults, PxU32 startIndex, bool& overflow);

...
#define	GJK_DEGENERATE 3
	...
	/*PX_PHYSX_COMMON_API PxGJKStatus GJK(const SphereV& a, const ConvexHullV& b, Ps::aos::Vec3V& closestA, Ps::aos::Vec3V& closestB, Ps::aos::Vec3V& normal, Ps::aos::FloatV& sqDist);
	PX_PHYSX_COMMON_API PxGJKStatus GJK(const SphereV& a, const BigConvexHullV& b, Ps::aos::Vec3V& closestA, Ps::aos::Vec3V& closestB, Ps::aos::Vec3V& normal, Ps::aos::FloatV& sqDist);*/
	...
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const TriangleV& a, const ConvexHullV& b);
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const TriangleV& a, const BigConvexHullV& b);

	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const BoxV& a, const ConvexHullV& b);
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const BoxV& a, const BigConvexHullV& b);  

	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const ConvexHullV& a, const BigConvexHullV& b);
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const ConvexHullV& a, const ConvexHullV& b);
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const BigConvexHullV& a, const BigConvexHullV& b);
	PX_PHYSX_COMMON_API PxGJKStatus GJKSeparatingAxis(const BigConvexHullV& a, const ConvexHullV& b);
